...
const About = () => {
    return (
        <div className="About">
            ...
            <p>
                This project is part of Business Problem Modelling Contest at Mathematics Faculty
                (Complutense University of Madrid). To learn more about the Contest, visit its{' '}
                <a href="https://matematicas.ucm.es/modelizacion-de-problemas-de-empresas">
                    webpage
                </a>
                Feel free to contact e-motion team to gain insight on the project or just to share
                any thoughts!
                <ul>
                    <li>
